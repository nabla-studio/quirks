...
export const quicksilver: Chain = {
  ...
  codebase: {
    ...
    recommended_version: 'v1.5.5',
    compatible_versions: ['v1.5.5', 'v1.5.5-hotfix.0'],
    binaries: {
      'linux/amd64':
        'https://github.com/ingenuity-build/quicksilver/releases/download/v1.5.5/quicksilverd-v1.5.5-amd64',
    },
    ...
    versions: [
      ...
      },
      {
        ...
        compatible_versions: ['v1.4.7'],
        binaries: {
          'linux/amd64':
            'https://github.com/ingenuity-build/quicksilver/releases/download/v1.4.7/quicksilverd-v1.4.7-amd64',
        },
        cosmos_sdk_version: 'v0.46.16',
        consensus: {
          type: 'cometbft',
      ...
      },
      {
        ...
        binaries: {
          'linux/amd64':
            'https://github.com/ingenuity-build/quicksilver/releases/download/v1.5.0/quicksilverd-v1.5.0-amd64',
        },
        cosmos_sdk_version: 'v0.46.16',
        consensus: {
          type: 'cometbft',
