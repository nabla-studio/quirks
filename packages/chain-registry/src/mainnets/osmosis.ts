...
export const osmosisVersions: Versions = {
  ...
  versions: [
    ...
    },
    {
      ...
      compatible_versions: ['v24.0.1', 'v24.0.0'],
      ...
      binaries: {
        'linux/amd64':
          'https://github.com/osmosis-labs/osmosis/releases/download/v24.0.1/osmosisd-24.0.1-linux-amd64',
        'linux/arm64':
          'https://github.com/osmosis-labs/osmosis/releases/download/v24.0.1/osmosisd-24.0.1-linux-arm64',
      },
      previous_version_name: 'v23',
      next_version_name: 'v25',
    },
    {
      name: 'v25',
      tag: 'v25.0.0',
...
export const osmosisAssetList: AssetList = {
  ...
  assets: [
    ...
    },
    {
      ...
      extended_description:
        'ION DAO is governed by ION holders. ION is the second native token of Osmosis, the biggest DEX in Cosmos. The origin of ION was a meme coin, but ION DAO has been trying to find ways to add values on ION.',
      denom_units: [
        {
          denom: 'uion',
          exponent: 0,
    ...
    },
    {
      ...
      extended_description:
        'bOSMO - solving capital inefficiencies in the NFT market space',
      denom_units: [
        {
          denom:
    ...
    },
    {
      ...
      keywords: ['gaming', 'staking', 'osmosis_unlisted'],
    },
    {
    ...
    },
    {
      ...
      extended_description:
        'ashLAB - receipt token recieved when burning LAB via ASH DAOs Furnace',
      denom_units: [
        {
          denom:
