...
export const akash: Chain = {
  ...
  codebase: {
    ...
    binaries: {
      'linux/amd64':
        'https://github.com/akash-network/node/releases/download/v0.34.1/akash_linux_amd64.zip',
      'linux/arm64':
        'https://github.com/akash-network/node/releases/download/v0.34.1/akash_linux_arm64.zip',
    },
  ...
  explorers: [
    ...
    },
    {
      ...
      account_page:
        'https://mainnet.whispernode.com/akash/account/${accountAddress}',
    },
  ],
  images: [
    {
