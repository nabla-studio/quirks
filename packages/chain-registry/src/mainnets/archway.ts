...
export const archway: Chain = {
  ...
  codebase: {
    ...
    binaries: {
      'linux/amd64':
        'https://github.com/archway-network/archway/releases/download/v7.0.1/archwayd_linux_amd64',
      'linux/arm64':
        'https://github.com/archway-network/archway/releases/download/v7.0.1/archwayd_linux_arm64',
      'darwin/amd64':
        'https://github.com/archway-network/archway/releases/download/v7.0.1/archwayd_darwin_amd64',
      'darwin/arm64':
        'https://github.com/archway-network/archway/releases/download/v7.0.1/archwayd_darwin_arm64',
    },
  ...
  explorers: [
    ...
    },
    {
      ...
      account_page:
        'https://mainnet.whispernode.com/archway/account/${accountAddress}',
    },
  ],
  images: [
    {
