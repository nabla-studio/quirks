...
export const nibirudevnet: Chain = {
  ...
  codebase: {
    ...
    genesis: {
      genesis_url:
        'https://raw.githubusercontent.com/NibiruChain/Networks/main/Testnet/nibiru-devnet-1/genesis.json',
    },
    versions: [
      {
        name: 'v1.0.0',
...
export const nibirudevnetAssetList: AssetList = {
