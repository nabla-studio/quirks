...
export const galacticatestnet: Chain = {
  ...
  codebase: {
    ...
    genesis: {
      genesis_url:
        'https://raw.githubusercontent.com/Galactica-corp/networks/main/galactica_9301-1/genesis.json',
    },
    versions: [
      {
        name: 'v0.1.1',
  ...
  peers: {
    seeds: [
      {
        id: '2b590732225bca0f3f55db543861063c705bcd40',
        address: 'seed01-reticulum.galactica.com:26656',
        provider: 'Galactica',
      },
      {
        id: 'fe758700e25b59b6ba6e2784badcb6024ba1b760',
        address: 'seed02-reticulum.galactica.com:26656',
        provider: 'Galactica',
      },
      {
        id: '028d8c875660f0e3fb1d893acd0b2220c619625f',
        address: 'seed03-reticulum.galactica.com:26656',
        provider: 'Galactica',
      },
    ],
    persistent_peers: [],
...
export const galacticatestnetAssetList: AssetLists = {
