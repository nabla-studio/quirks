...
export const nibirutestnet: Chain = {
  ...
  codebase: {
    ...
    genesis: {
      genesis_url:
        'https://raw.githubusercontent.com/NibiruChain/Networks/main/Testnet/nibiru-testnet-1/genesis.json',
    },
    versions: [
      {
        name: 'v1.0.0',
...
export const nibirutestnetAssetList: AssetList = {
