...
export const nibirudevnet2: Chain = {
  ...
  codebase: {
    ...
    genesis: {
      genesis_url:
        'https://raw.githubusercontent.com/NibiruChain/Networks/main/Testnet/nibiru-devnet-2/genesis.json',
    },
    versions: [
      {
        name: 'v1.0.0',
...
export const nibirudevnet2AssetList: AssetList = {
