...
export const secretnetworktestnet: Chain = {
  ...
  codebase: {
    ...
    binaries: {
      'linux/amd64':
        'https://github.com/scrtlabs/SecretNetwork/releases/download/v1.9.3/secretnetwork_1.9.3_testnet_goleveldb_amd64.deb',
    },
...
export const secretnetworktestnetAssetList: AssetLists = {
