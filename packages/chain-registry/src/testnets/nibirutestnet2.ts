...
export const nibirutestnet2: Chain = {
  ...
  codebase: {
    ...
    genesis: {
      genesis_url:
        'https://raw.githubusercontent.com/NibiruChain/Networks/main/Testnet/nibiru-testnet-2/genesis.json',
    },
    versions: [
      {
        name: 'v1.0.0',
...
export const nibirutestnet2AssetList: AssetList = {
